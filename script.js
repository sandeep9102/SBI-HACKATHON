...
async function submitFraudForm(event) {
    ...
    try {
        let response = await fetch("https://frauddetection-production-40cd.up.railway.app/model/predict/", {
            method: "POST",
...
async function uploadBulkFile() {
    ...
    try {
        ...
        const uploadResponse = await fetch("https://frauddetection-production-40cd.up.railway.app/model/predict_file/", {
            method: "POST",
            body: formData,
        });
        ...
        const downloadResponse = await fetch("https://frauddetection-production-40cd.up.railway.app/model/download_file/", {
            method: "GET",
        });
...
async function authenticateSignature() {
    ...
    try {
        const response = await fetch("https://frauddetection-production-40cd.up.railway.app/model/verify_signature/", {
            method: "POST",
            body: formData
        });
